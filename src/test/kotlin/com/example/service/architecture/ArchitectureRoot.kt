 ...
 *
 * [ROOT] is **derived** from the package [ServiceApplication] actually sits in, not written
 ...
 * (see `ServiceApplication`): it makes the package root a fact about the code rather than
 * a convention someone maintains.
 *
 * SDD: see `documentation/adr/0007-archunit-boundary-enforcement.adr.md`.
 */
object ArchitectureRoot {
    val ROOT: String = ServiceApplication::class.java.packageName
